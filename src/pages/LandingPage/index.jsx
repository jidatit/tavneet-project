...
function LandingPage() {
  ...
  return (
    <div className="font-poppins bg-black">
      ...
      <section className=" text-white bg-[#0f0f0f] w-full h-screen gap-2 flex flex-col md:flex-row items-center justify-start">
        <div className="md:w-[50%] w-full flex flex-col justify-center items-center px-20">
          <div className="w-full flex-col justify-start items-center gap-4">
            <h2 className="text-[64px] mb-[30px] font-bold leading-snug">Location</h2>
            ...
            <div className="w-full flex flex-col justify-center mt-[30px] items-start">
              ...
              <div className="lg:w-[80%] w-full flex flex-row gap-x-[50px] mt-[20px] mb-[20px] justify-between items-center">
                <div className="flex flex-row w-[50%] justify-start items-center gap-3">
                  <img src={l1} alt="" />
              ...
              <div className="lg:w-[80%] w-full flex flex-row gap-x-[50px] mt-[20px] mb-[20px] justify-between items-center">
                <div className="flex w-[50%] flex-row justify-start items-center gap-3">
                  <img src={l5} alt="" />
                  <div className="flex flex-col gap-1 justify-center items-start">
      ...
      <section className=" text-black bg-[#eaeaea] w-full h-screen gap-2 flex flex-col items-center justify-start">
        <div className="md:w-[95%] w-full flex flex-col justify-center items-center px-20">
          <div className="w-full flex-col justify-start items-center gap-4">
            <h2 className="text-[64px] mb-[30px] mt-[90px] font-bold leading-snug">Construction technology</h2>
            <div className="w-full border-b border-gray-400 h-[1px]"></div>

            <div className="w-full flex flex-col gap-y-[80px] justify-center mt-[30px] items-start">

              <div className="w-full flex flex-row gap-x-[50px] mt-[20px] mb-[20px] justify-between items-center">
      ...
      <section className=" text-black bg-[#e3e3e3] w-full h-screen gap-2 flex flex-col md:flex-row items-center justify-start">
        <div className="md:w-[60%] border-r h-[40%] border-gray-400 w-full flex flex-col justify-center items-center px-20">
          <div className="w-full flex-col justify-start items-center gap-4">
            <h2 className="text-[64px] mb-[30px] font-bold text-5xl leading-snug">Let's talk!</h2>
