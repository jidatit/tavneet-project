...
function LandingPage() {
  ...
  return (
    <div className="font-poppins bg-black">
      ...
      <Segments sectionHeight={sectionHeight} />
      ...
      <section className={ `text-black bg-[#eaeaea] w-full ${ sectionHeight ? 'h-[700px]':'h-full'} gap-2 flex flex-col items-center justify-start`}>
      ...
      <footer className="text-[#afacac] h-[40vh] md:h-[30vh] p-5 bg-[#0f0f0f] gap-2 w-full flex flex-row justify-center items-center">
