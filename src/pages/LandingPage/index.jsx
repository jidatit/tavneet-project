...
function LandingPage() {
  ...
  return (
    <div className="font-poppins bg-black">
      ...
      <section className=" text-white bg-[#0f0f0f] w-full h-[170vh] md:h-screen gap-2 flex flex-col md:flex-row items-center justify-start">
      ...
      <section className=" text-black bg-[#eaeaea] w-full lg:h-screen gap-2 flex flex-col items-center justify-start">
        <div className="md:w-[95%] w-full flex flex-col justify-center items-center px-5 md:px-20">
          <div className="w-full flex-col justify-start items-center gap-4">
            ...
            <div className="w-full flex gap-y-[50px] md:gap-y-[80px] flex-row flex-wrap gap-x-[30px] md:gap-x-[50px] mt-[30px] mb-[20px] md:mt-[60px] justify-between items-center">

              <div className="flex flex-col md:flex-row max-w-[50%] lg:w-[30%] justify-start items-start md:items-center gap-3">
      ...
      <footer className="text-[#afacac] md:h-[30vh] p-5 bg-[#0f0f0f] gap-2 w-full flex flex-col md:flex-row justify-center items-center">

        <div className="md:w-[30%] flex flex-col justify-between items-start h-full">
        ...
        <div className="md:w-[30%] flex flex-col justify-center gap-[20px] items-center h-full">
        ...
        <div className="md:w-[30%] flex flex-col justify-between items-end h-full">
